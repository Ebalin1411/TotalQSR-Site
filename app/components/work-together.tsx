        ...
        <div className="md:px-[50px] md:py-[100px] px-5 py-10 ">
                <div className="tracking-tight flex gap-10 flex-col-reverse lg:flex-row w-full">
                    <div className="w-full lg:w-1/2">
                        <Image src={Worktogethericon} alt='Work together' className='w-full'/>
                    </div>
                    <div className="w-full lg:w-1/2 lg:pl-[5%] lg:pt-[10%]" >
                        <h1 className='text-3xl  md:text-6xl font-bold md:leading-snug'>
                            Work <span className='bg-Work bg-no-repeat bg-bottom bg-contain'>together</span></h1>
                        <p className='text-lg my-4 md:my-6'>With TotalQSR,share your templates and pages with your colleagues and collaborate on them</p>
